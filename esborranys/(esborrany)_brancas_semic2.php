...
$empresaId = '4';  // Especificamos el ID de la empresa directamente aquí

// Obtener nombre de la empresa
$stmt_empresa = $conn->prepare("SELECT Name FROM Companies WHERE Id = 4");
...
$stmt_sucursales = $conn->prepare("SELECT Address, Zipcode, City, Province FROM Branches WHERE Id = 4");
